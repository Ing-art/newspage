            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @if (Auth::user()->hasRole('writer'))
                    <div class="container col-12 card text-center table-responsive">
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if (Auth::user()->can('delete', $article))
                                                <a class="btn btn-danger mx-2"
                                                    href="{{ route('articles.delete', $article->id) }}">Delete</a>
                                            @endif
                                        </td>
                                    </tr>
                                @empty
                        ...
                        {{-- Submitted articles awaiting editorial review --}}
                        @if (!empty($submittedarticles))
                            <div class="container col-12 card text-center table-responsive">
                                <h2 class="text-center mt-3 mb-3 fw-bold">Submitted Articles</h2>
                                <table class="table table-stripped table-bordered table-hover align-middle">
                                    <tr class="text-center">
                                        <th>Id</th>
                                        <th>Author</th>
                                    ...
                                    @forelse($submittedarticles as $article)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $article->user->name }}</td>
                                            <td class="text-center">
                                                <a href="{{ route('articles.show', $article->id) }}">{{ $article->headline }}</a>
                                            </td>
                                            <td class="text-center" style="max-width: 80px">
                                                <div class="d-flex justify-content-center">
                                                    <img class="rounded" style="max-width: 80%"
                                            ...
                                            <td class="text-center">Pending review</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center">Nothing to show</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if (Auth::user()->can('reject', $article))
                                                <form class="d-inline" method="POST"
                                                    action="{{ route('articles.reject', $article->id) }}">
                                                    @csrf
                                                    @method('PATCH')
